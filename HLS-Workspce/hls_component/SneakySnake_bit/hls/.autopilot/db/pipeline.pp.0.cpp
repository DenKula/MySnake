# 1 "/home/deniz/Projects/SneakySnake/SneakySnake-HLS-HBM/hw/pipeline.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/deniz/Projects/SneakySnake/SneakySnake-HLS-HBM/hw/pipeline.cpp" 2

# 1 "/home/deniz/Projects/SneakySnake/SneakySnake-HLS-HBM/hw/pipeline.h" 1
...
# 5 "/home/deniz/Projects/SneakySnake/SneakySnake-HLS-HBM/hw/pipeline.h" 2
...
# 6 "/home/deniz/Projects/SneakySnake/SneakySnake-HLS-HBM/hw/pipeline.h" 2
...
# 7 "/home/deniz/Projects/SneakySnake/SneakySnake-HLS-HBM/hw/pipeline.h" 2



typedef ap_uint<256> d_bit_in_type;
typedef ap_uint<256/2> d_bit_out_type;
typedef ap_uint<8> d_bit_out_tiny_type;
typedef ap_uint<256> d_out_type;
typedef ap_uint<2> d_in_type;
typedef ap_uint<2> d_final_out_type;

# 1 "/home/deniz/oc-accel/actions/include/hls_snap_1024.H" 1
# 22 "/home/deniz/oc-accel/actions/include/hls_snap_1024.H"
# 1 "/tools/Xilinx/Vitis/2024.2/common/technology/autopilot/ap_int.h" 1
# 23 "/home/deniz/oc-accel/actions/include/hls_snap_1024.H" 2
...
# 24 "/home/deniz/oc-accel/actions/include/hls_snap_1024.H" 2
# 67 "/home/deniz/oc-accel/actions/include/hls_snap_1024.H"
typedef ap_uint<256> snap_membus_256_t;
typedef ap_uint<512> snap_membus_512_t;
typedef ap_uint<1024> snap_membus_1024_t;
typedef ap_uint<256> snap_HBMbus_t;
...
# 17 "/home/deniz/Projects/SneakySnake/SneakySnake-HLS-HBM/hw/pipeline.h" 2
...
__attribute__((sdx_kernel("SneakySnake_bit", 0))) int SneakySnake_bit(int ReadLength, d_bit_in_type &ReadSeq, d_bit_in_type &RefSeq, int EditThreshold, int KmerSize);
# 3 "/home/deniz/Projects/SneakySnake/SneakySnake-HLS-HBM/hw/pipeline.cpp" 2
# 307 "/home/deniz/Projects/SneakySnake/SneakySnake-HLS-HBM/hw/pipeline.cpp"
unsigned largest(unsigned arr[], unsigned n)
{
    unsigned i;
    ...
    VITIS_LOOP_317_1: for (i = 1; i < 11; i++)
        if (arr[i] > max)
            max = arr[i];
...
unsigned count_one_bit(d_bit_out_tiny_type &input_seq, unsigned seq_length)
{
    ...
    VITIS_LOOP_330_1: for (index=0;index<8;index++)
    {
#pragma HLS PIPELINE
...
int largest_bit(d_out_type arr, int n)
{
    ...
    VITIS_LOOP_352_1: for (i = 1; i < n; i++)
...
#pragma HLS PIPELINE
 if(DNA_1((i+1),i) || DNA_1((i+2),(i+1)))
            DNA_nsh((index+1),index) = 1;
        else
            DNA_nsh((index+1),index) = 0;
        index=index+1;
...
#pragma HLS PIPELINE
 if(DNA_2((i+1),i) || DNA_2((i+2),(i+1)))
            DNA_shl_one((index+1),index) = 1;
        else
            DNA_shl_one((index+1),index) = 0;
        index=index+1;
    }

    DNA_shl_one((256/2)-1,(256/2)-2) =1;
                                                      ;
...
#pragma HLS PIPELINE
 if(DNA_3((i+1),i) || DNA_3((i+2),(i+1)))
            DNA_shl_two((index+1),index) = 1;
        else
            DNA_shl_two((index+1),index) = 0;
        index=index+1;
    }
    DNA_shl_two((256/2)-1,(256/2)-2) =1;
    DNA_shl_two((256/2)-3,(256/2)-4) =1;
...
#pragma HLS PIPELINE
 if(DNA_6((i+1),i) || DNA_6((i+2),(i+1)))
            DNA_shl_three((index+1),index) = 1;
        else
            DNA_shl_three((index+1),index) = 0;
        index=index+1;
    }
...
#pragma HLS PIPELINE
 if(DNA_7((i+1),i) || DNA_7((i+2),(i+1)))
            DNA_shl_four((index+1),index) = 1;
        else
            DNA_shl_four((index+1),index) = 0;
        index=index+1;
    }
    DNA_shl_four((256/2)-1,(256/2)-2) =1;
...
#pragma HLS PIPELINE
 if(DNA_8((i+1),i) || DNA_8((i+2),(i+1)))
            DNA_shl_five((index+1),index) = 1;
        else
            DNA_shl_five((index+1),index) = 0;
        index=index+1;
     }
        DNA_shl_five((256/2)-1,(256/2)-2) =1;
    DNA_shl_five((256/2)-3,(256/2)-4) =1;
...
#pragma HLS PIPELINE
 if(DNA_4((i+1),i) || DNA_4((i+2),(i+1)))
            DNA_shr_one((index+1),index) = 1;
        else
            DNA_shr_one((index+1),index) = 0;
        index=index+1;
    }
        DNA_shr_one(1,0) =1;
...
#pragma HLS PIPELINE
 if(DNA_5((i+1),i) || DNA_5((i+2),(i+1)))
            DNA_shr_two((index+1),index) = 1;
        else
            DNA_shr_two((index+1),index) = 0;
        index=index+1;
     }
      DNA_shr_two(1,0) =1;
       DNA_shr_two(2,1) =1;
...
#pragma HLS PIPELINE
 if(DNA_9((i+1),i) || DNA_9((i+2),(i+1)))
            DNA_shr_three((index+1),index) = 1;
        else
            DNA_shr_three((index+1),index) = 0;
        index=index+1;
  }
    DNA_shr_three(1,0) =1;
       DNA_shr_three(2,1) =1;
...
#pragma HLS PIPELINE
 if(DNA_10((i+1),i) || DNA_10((i+2),(i+1)))
            DNA_shr_four((index+1),index) = 1;
        else
            DNA_shr_four((index+1),index) = 0;
        index=index+1;
  }
...
#pragma HLS PIPELINE
 if(DNA_11((i+1),i) || DNA_11((i+2),(i+1)))
            DNA_shr_five((index+1),index) = 1;
        else
            DNA_shr_five((index+1),index) = 0;
          index=index+1;
    }
...
#pragma HLS PIPELINE
 counter_A[0]=count_one_bit(DNA_nsh,256/2);
        counter_A[1]=count_one_bit(DNA_shl_one,256/2);
        counter_A[2]=count_one_bit(DNA_shl_two,256/2);
        counter_A[3]=count_one_bit(DNA_shl_three,256/2);
        counter_A[4]=count_one_bit(DNA_shl_four,256/2);
        counter_A[5]=count_one_bit(DNA_shl_five,256/2);
        counter_A[6]=count_one_bit(DNA_shr_one,256/2);
        counter_A[7]=count_one_bit(DNA_shr_two,256/2);
        counter_A[8]=count_one_bit(DNA_shr_three,256/2);
        counter_A[9]=count_one_bit(DNA_shr_four,256/2);
        counter_A[10]=count_one_bit(DNA_shr_five,256/2);
...
# 697 "/home/deniz/Projects/SneakySnake/SneakySnake-HLS-HBM/hw/pipeline.cpp"
