...
#define XSNEAKYSNAKE_BIT_CONTROL_ADDR_AP_CTRL            0x00
#define XSNEAKYSNAKE_BIT_CONTROL_ADDR_GIE                0x04
#define XSNEAKYSNAKE_BIT_CONTROL_ADDR_IER                0x08
#define XSNEAKYSNAKE_BIT_CONTROL_ADDR_ISR                0x0c
#define XSNEAKYSNAKE_BIT_CONTROL_ADDR_AP_RETURN          0x10
#define XSNEAKYSNAKE_BIT_CONTROL_BITS_AP_RETURN          32
#define XSNEAKYSNAKE_BIT_CONTROL_ADDR_READLENGTH_DATA    0x18
#define XSNEAKYSNAKE_BIT_CONTROL_BITS_READLENGTH_DATA    32
#define XSNEAKYSNAKE_BIT_CONTROL_ADDR_READSEQ_DATA       0x20
#define XSNEAKYSNAKE_BIT_CONTROL_BITS_READSEQ_DATA       256
#define XSNEAKYSNAKE_BIT_CONTROL_ADDR_REFSEQ_DATA        0x44
#define XSNEAKYSNAKE_BIT_CONTROL_BITS_REFSEQ_DATA        256
#define XSNEAKYSNAKE_BIT_CONTROL_ADDR_EDITTHRESHOLD_DATA 0x68
#define XSNEAKYSNAKE_BIT_CONTROL_BITS_EDITTHRESHOLD_DATA 32
#define XSNEAKYSNAKE_BIT_CONTROL_ADDR_KMERSIZE_DATA      0x70
#define XSNEAKYSNAKE_BIT_CONTROL_BITS_KMERSIZE_DATA      32
