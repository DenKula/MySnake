...
HLS_SOURCES = ../../../../../../SneakySnake/kthread.c ../../../../../../SneakySnake-HLS-HBM/hw/tb_wrapper.cpp ../../../../../../SneakySnake-HLS-HBM/hw/pipeline.cpp
...
$(ObjDir)/kthread.o: ../../../../../../SneakySnake/kthread.c $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../../SneakySnake/kthread.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -std=gnu99 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/kthread.d

$(ObjDir)/tb_wrapper.o: ../../../../../../SneakySnake-HLS-HBM/hw/tb_wrapper.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../../SneakySnake-HLS-HBM/hw/tb_wrapper.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_wrapper.d
...
$(ObjDir)/pipeline.o: ../../../../../../SneakySnake-HLS-HBM/hw/pipeline.cpp $(ObjDir)/.dir csim.mk
	...
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -I/home/deniz/oc-accel/actions/include -I/home/deniz/oc-accel/actions/include  $(IFLAG) $(DFLAG) $< -o $@ ; \
