...
entity SneakySnake_bit_NeighborhoodMap_bit_Pipeline_VITIS_LOOP_462_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of SneakySnake_bit_NeighborhoodMap_bit_Pipeline_VITIS_LOOP_462_5 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln462_fu_90_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_condition_exit_pp0_iter0_stage0 : STD_LOGIC;
    signal ap_loop_exit_ready : STD_LOGIC;
    signal ap_ready_int : STD_LOGIC;
    signal index_7_fu_52 : STD_LOGIC_VECTOR (6 downto 0) := "0000000";
...
begin
    partselect_2ns_256ns_32ns_2_1_1_U23 : component SneakySnake_bit_partselect_2ns_256ns_32ns_2_1_1
    generic map (
        DATAWIDTH => 256,
        ADDRWIDTH => 32,
        DATA1WIDTH => 2)
    ...
    index_7_fu_52_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                if ((icmp_ln462_fu_90_p2 = ap_const_lv1_0)) then 
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_pp0_stage0_iter0, icmp_ln462_fu_90_p2)
    begin
        if (((icmp_ln462_fu_90_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    ap_sig_allocacmp_index_assign_proc : process(ap_CS_fsm_state1, index_7_fu_52, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
