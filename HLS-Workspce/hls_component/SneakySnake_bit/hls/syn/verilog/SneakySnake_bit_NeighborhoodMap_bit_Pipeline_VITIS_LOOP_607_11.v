...
output   ap_ready;
input  [255:0] DNA_11;
output  [127:0] storemerge44_i_out;
output   storemerge44_i_out_ap_vld;

reg ap_idle;
reg storemerge44_i_out_ap_vld;
...
reg   [7:0] i_fu_56;
wire   [7:0] i_1_fu_184_p2;
reg   [7:0] ap_sig_allocacmp_i_load;
reg   [127:0] storemerge44_i_fu_60;
wire   [127:0] storemerge_i_fu_174_p4;
wire   [31:0] tmp_58_i_fu_112_p2;
wire   [6:0] tmp_s_fu_120_p4;
wire   [7:0] or_ln_fu_130_p3;
wire   [31:0] tmp_60_i_fu_142_p2;
wire   [1:0] tmp_58_i_fu_112_p3;
wire   [1:0] tmp_60_i_fu_142_p3;
wire   [1:0] or_ln610_fu_150_p2;
wire   [0:0] icmp_ln610_fu_156_p2;
wire   [1:0] storemerge_i_fu_174_p2;
wire   [31:0] storemerge_i_fu_174_p3;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [1:0] tmp_58_i_fu_112_p0;
wire   [1:0] tmp_60_i_fu_142_p0;
wire   [127:0] storemerge_i_fu_174_p0;
wire    ap_ce_reg;
...
always @ (*) begin
    if (((ap_loop_exit_ready == 1'b1) & (icmp_ln607_fu_90_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        storemerge44_i_out_ap_vld = 1'b1;
    end else begin
        storemerge44_i_out_ap_vld = 1'b0;
    end
end
...
assign i_1_fu_184_p2 = (ap_sig_allocacmp_i_load + 8'd2);
...
assign or_ln610_fu_150_p2 = (tmp_60_i_fu_142_p3 | tmp_58_i_fu_112_p3);

assign or_ln_fu_130_p3 = {{tmp_s_fu_120_p4}, {1'd1}};

assign storemerge44_i_out = storemerge44_i_fu_60;

assign storemerge_i_fu_174_p2 = ((icmp_ln610_fu_156_p2[0:0] == 1'b1) ? 2'd0 : 2'd1);

assign storemerge_i_fu_174_p3 = ap_sig_allocacmp_index_1;

assign tmp_58_i_fu_112_p2 = ap_sig_allocacmp_i_load;

assign tmp_60_i_fu_142_p2 = or_ln_fu_130_p3;
